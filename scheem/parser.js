  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "quote": parse_quote,
        "wsexpression": parse_wsexpression,
        "lb": parse_lb,
        "rb": parse_rb,
      ...
      function parse_quote() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, exp) {return ['quote'].concat([exp]);})(pos0, result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_atom() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, chars) { var atom = chars.join(""); return isNaN(atom)?atom:Number(atom);})(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
